...
{
    public class CreatesANewAppTaskCreatedResponse
    {
        [JsonProperty("taskDefinitionPropertiesId")]
        public string TaskDefinitionPropertiesId { get; set; }

        [JsonProperty("appTasksMetadata")]
        public AppTasksMetadata AppTasksMetadata { get; set; }
    ...
    public class AppTasksMetadata
    {
        ...
        public FpsContext FpsContext { get; set; }
