...
namespace GreenLight.DX.Docs.Xaml.Primitives
{
    public class Argument
    {
        ...
        public string Name
        {
            get
            {
                return XDocumentHelpers.GetAttribute(PropertyElement, LocalNames.ArgumentDefinitionName)?.Value;
            }
        }
        public string Description
        {
            get
            {
                var attr = XDocumentHelpers.GetAttribute(PropertyElement, LocalNames.Description);
            ...
            get
            {
                ...
                if (Argument_ExpressionElement is XElement)
                {
                    ...
                    switch (element.Name.LocalName)
                    {
                        ...
                        case "Literal":
                            return "\"" + XDocumentHelpers.GetAttribute(element, LocalNames.LiteralValue).Value + "\"";
                        default:
                    ...
                    if (ArgumentObject == null || ArgumentObject is XAttribute)
                    {
                        var newArgumentElement = new XElement(
                            ...
                            new XElement(
                                ...
                                new XAttribute(NamespaceNames.X + LocalNames.ArgumentValueType, Type),
                                new XElement(
                    ...
                    if (ArgumentObject is XElement)
                    {
                        ...
                        switch (element.Name.LocalName)
                        {
                            case "CSharpValue":
                                ...
                                break;
                            case "Literal":
                                var attribute = XDocumentHelpers.GetAttribute((XElement)Argument_ExpressionElement, LocalNames.LiteralValue);
                                attribute.Value = "";
                                return;
                            default:
                                throw new NotSupportedException("Unkonwn element type");
        ...
        private XAttribute Property_TypeAttribute
        {
            get
            {
                return XDocumentHelpers.GetAttribute(PropertyElement, LocalNames.ArgumentDefinitionType);
            }
        }
        ...
        private XAttribute Argument_DirectionWrapper_TypeAttribute
        {
            get
            {
                ...
                {
                    return XDocumentHelpers.GetAttribute(Argument_DirectionWrapperElement, LocalNames.ArgumentWrapperType);
                }
            }
        }
        ...
        private XObject Argument_ExpressionElement
        {
            get
            {
                ...
                {
                    return ((XElement)ArgumentObject).Descendants().FirstOrDefault(ved => LocalNames.Expressions.Contains(ved.Name.LocalName));
                }
            }
        }
        ...
        private XAttribute Argument_Expression_TypeElement
        {
            get
            {
                ...
                return XDocumentHelpers.GetAttribute((XElement)Argument_ExpressionElement, LocalNames.ArgumentValueType);
            }
        }
