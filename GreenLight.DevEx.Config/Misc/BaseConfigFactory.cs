...
namespace GreenLight.DX.Misc
{
    ...
    public static class BaseConfigFactory
    {
        ...
        public static TDerived FromDictionary<TDerived>(Dictionary<string, object> dictionary) where TDerived : BaseConfig, new()
        {
            TDerived instance = new TDerived();
