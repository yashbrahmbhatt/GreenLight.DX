...
namespace GreenLight.DX.Config.Shared.Models
{
    ...
    /// </summary>
    public class ConfigBase : DynamicObject, ISerializable
    {
        /// <summary>
        ...
        protected ConfigBase(SerializationInfo info, StreamingContext context)
        {
        ...
        public override bool TryGetMember(GetMemberBinder binder, out object result)
        {
            ...
            if (typeof(ConfigBase).IsAssignableFrom(property.PropertyType))
            {
                ...
                {
                    var nestedObject = Activator.CreateInstance(property.PropertyType) as ConfigBase;
        ...
        public override bool TrySetMember(SetMemberBinder binder, object value)
        {
            ...
            if (typeof(ConfigBase).IsAssignableFrom(property.PropertyType))
            {
                if (value is ConfigBase nestedObject)
                {
                    Data[propertyName] = nestedObject;
                    return true;
                }
